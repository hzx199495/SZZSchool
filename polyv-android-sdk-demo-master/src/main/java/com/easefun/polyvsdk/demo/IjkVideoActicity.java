...
public class IjkVideoActicity extends Activity {
	...
	public static Intent newIntent(Context context, int playMode, int playType, String value,
			boolean startNow) {
	...
	public static void intentTo(Context context, int playMode, int playType, String value, boolean startNow) {
		context.startActivity(newIntent(context, playMode, playType, value, startNow));
	}

	public static void intentTo(Context context, int playMode, int playType, String value,
			boolean isMustFromLocal, Video.HlsSpeedType hlsSpeedType, boolean startNow) {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		videodown = (LinearLayout) findViewById(R.id.video_small1_ll);
		// handle arguments
		int playMode = getIntent().getIntExtra("playMode", 0);
		final int playType = getIntent().getIntExtra("playType", 0);
		...
		if (playMode == 0 || playType == 0 || TextUtils.isEmpty(value)) {
		...
		switch (playMode) {
		case PlayMode.landScape:
			changeToLandscape();
			break;

		case PlayMode.portrait:
			changeToPortrait();
			break;
		}
