...
//		非23或以上可以直接调用onClickExecuteOptions方法，注释掉以下使用到的其他代码
	...
	private void onClickExecuteOptions(int id) {
		...
		} else if (id == R.id.online_video_portrait) {
		...
		} else if (id == R.id.online_video_land_scape) {
